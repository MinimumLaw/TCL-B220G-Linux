...
* F2 или DEL - вызов некоего аналога BIOS, позволяющего включить/выключить Secure Boot, Developer Mode (на данный момент неизвестно что этот режим дает) и запустить режим поставки Shipping mode (на данный момент неизвестно что этот режим дает)
